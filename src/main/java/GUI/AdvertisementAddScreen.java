...
public class AdvertisementAddScreen extends javax.swing.JFrame {
    ...
    public AdvertisementAddScreen() {
    }

    public AdvertisementAddScreen(HouseOwner houseOwner) {
        initComponents();
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (advertisementName.getText().isEmpty() || dailyPrice.getText().isEmpty() || address.getText().isEmpty() || shortDescription.getText().isEmpty()|| image1.getIcon() == null || image2.getIcon() == null || image3.getIcon() == null || image4.getIcon() == null || image5.getIcon() == null || image6.getIcon() == null) {
            ...
            if (yesPark.isSelected()) {
                ...
                house.setHasVehiclePark(false);

            }
            house.setHeating(heatingType.getSelectedItem().toString());
            house.setHouseOwnerId(houseOwner.getId());
            house.setId(0);
            house.setLocation(address.getText());
            house.setRoomNumber(roomNumber.getSelectedItem().toString());
            house.setShortDescription(shortDescription.getText());
            house.create(files, paths);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdvertisementAddScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdvertisementAddScreen().setVisible(true);
            }
        });
    }
